...
using Dragon_Age_Inquisition.Properties;
...
{  
    public partial class OptionForm : Form
    {
        ...
        private void OptionForm_Shown(object sender, EventArgs e)
        {
            ...
            //Keybinding options
            /*for (x = 0; x < Shadow.keyBinds.Length; x++)
            {
                string[] item = { Shadow.keyNames[x], ParseKeyData(Shadow.keyBinds[x]) };
        ...
        private void keyList_DoubleClick(object sender, EventArgs e)
        {
            ...
            Shadow.keyBinds[keyListSelIndex] = InputBox.keyVal;*/
        }
